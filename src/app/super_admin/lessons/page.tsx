...
import { useReactTable, getCoreRowModel, ColumnDef, ColumnFiltersState, getFilteredRowModel, flexRender, getPaginationRowModel } from '@tanstack/react-table';
import { FiSearch, FiPlus, FiX, FiEdit2, FiTrash2, FiFilter, FiSave, FiImage, FiChevronLeft, FiChevronRight } from 'react-icons/fi';
...
const SDGS = [
  ...
  { id: '6', name: 'Clean Water and Sanitation', image: '/sdg6.webp', color: '#e5243b' },
  { id: '7', name: 'Affordable and clean energy', image: '/sdg7.png', color: '#DDA63A' },
  { id: '8', name: 'Decent work and Economic growth', image: '/sdg8.webp', color: '#4C9F38' },
  { id: '9', name: 'Industry innovation and infrastructure', image: '/sdg9.webp', color: '#C5192D' },
  { id: '10', name: 'Reduced Inequalities', image: '/sdg10.webp', color: '#FF3A21' },
  { id: '11', name: 'Sustainable Cities and Communities', image: '/sdg11.webp', color: '#C5192D' },
  { id: '12', name: 'Responsible Consumption and Production', image: '/sdg12.webp', color: '#FF3A21' },
  { id: '13', name: 'Climate Action', image: '/sdg13.webp', color: '#e5243b' },
  { id: '14', name: 'Life below water', image: '/sdg14.webp', color: '#DDA63A' },
  { id: '15', name: 'Life on Land', image: '/sdg15.webp', color: '#4C9F38' },
  { id: '16', name: 'Peace, Justice and Strong Institutions', image: '/sdg16.png', color: '#C5192D' },
  { id: '17', name: 'Partnerships for the Goals', image: '/sdg17.webp', color: '#FF3A21' },
...
export default function ManageLessons() {
      ...
      cell: ({ row }) => (
        <ul className="list-disc list-inside">
          {row.original.activities.map((activity, i) => (
            <li key={i} className="text-sm line-clamp-1">{activity}</li>
          ))}
        </ul>
      ),
      size: 150
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editingLesson) {
      ...
      const newId = String(Math.max(0, ...data.map(l => parseInt(l.id))) + 1).padStart(3, '0');
      setData([...data, { 
        ...formData, 
        id: newId, 
    ...
    <div className="p-6 bg-white rounded-lg shadow-sm">
      ...
      {isFormOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            {formStep === 'select' ? (
              <div className="p-6">
                <h3 className="text-lg font-semibold mb-4">Select Sustainable Development Goal</h3>
              ...
              <form onSubmit={handleSubmit} className="p-6">
                ...
                {selectedSdg && (
                  <div className="flex items-center mb-6 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm">SDG {selectedSdg.id}: {selectedSdg.name}</p>
                    </div>
                  </div>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="mb-4">
                      <label htmlFor="interactiveQuestion" className="block text-sm font-medium text-gray-700 mb-1">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Create, update, and manage SDG lessons</p>
        </div>
        <button 
          onClick={() => {
            setIsFormOpen(true);
